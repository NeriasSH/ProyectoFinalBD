...
public class Proceso_Ventas extends javax.swing.JFrame {
    ...
    public Proceso_Ventas() {
        ...
        lista1 = listar.PVentas("Select * from view_lista");
        tabla.setModel(mitabla);

        String[] titulos = {"Codigo_V", "Clientes", "Platillo", "Forma de Pago", "Tipo de Pago", "Cantidad", "Precio Unitario", "Total", "IGV", "Importe Total"};
        ...
        for (ViewVentas l : lista1) {
           datos[0]=l.getCodig_Venta();
           datos[1]=l.getClientes();
           datos[2]=l.getPlatillo();
           datos[3]=l.getFormaPago();
           datos[4]=l.getTipoPago();
           datos[5]=""+l.getCantidad();
           datos[6]=""+l.getPrecioUnitario();
           datos[7]=""+l.getTotal();
           datos[8]=""+l.getIGV();
           datos[9]=""+l.getImporteT();
