...
public class VPagoEmpleado extends javax.swing.JFrame {

    /**
     * Creates new form VPagoEmpleado
     */
    public VPagoEmpleado() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Tabla Empleado");
    ...
    public void Listar(){
      ...
      ArrayList<Pagoempleado>lista1=new ArrayList<>();
       
      lista1=listar.PagoEmpleado();
      
       jTable2.setModel(mitabla);
       
       String[] titulos = {"Codigo","Fecha","Monto","ID_Empleado"};
       ...
       for(Pagoempleado l:lista1){
           datos[0] =l.getIdPago();
           datos[1]=l.getFecha();
           datos[2]=""+l.getMonto();
           datos[3]=l.getIdEmpleado();
...
public void Insertar(){
        ...
        insertar.PagoEmpleado(idT, idT2, text4, text5);
    }
...
public void Modificar(){
        ...
        modificar.PagoEmpleado(idT, idT2, text4);
    }

public void Eliminar(){
        EliminarDatos eliminar = new EliminarDatos();
        String idT = jTextField1.getText();
        eliminar.PagoEmpleado(idT);
...
public void Limpiar(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VPagoEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VPagoEmpleado().setVisible(true);
            }
        });
    }
