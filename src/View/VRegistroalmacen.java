...
public class VRegistroalmacen extends javax.swing.JFrame {

    /**
     * Creates new form VRegistroalmacen
     */
    public VRegistroalmacen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Registro Almacen");
    ...
    public void Listar(){
      ...
      ArrayList<RegistroAlmacen>lista1=new ArrayList<>();
       
      lista1=listar.RegistroAlmacen();
      
       jTable2.setModel(mitabla);
       
       String[] titulos = {"Codigo","ID_Producto","Cantidad","FechaEntrada","FechaVencimoiento","Empleado"};
       ...
       for(RegistroAlmacen l:lista1){
           datos[0] =l.getIdRegistroAlmacen();
           datos[1]=l.getIdProducto();
           datos[2]=""+l.getCantidadEntrada();
           datos[3]=""+l.getFechaEntrada();
           datos[4]=""+l.getFechaVencimiento();
           datos[5]=""+l.getIdEmpleado();
...
public void Insertar(){
        ...
        insertar.RegistroAlmacen(idT, idT2, text4, text5, text6, text7);
    }
...
public void Modificar(){
       ...
       String text7 = jTextField7.getText();
        ...
        modificar.RegistroAlmacen(idT, text4, text5, text6);
    }

public void Eliminar(){
        EliminarDatos eliminar = new EliminarDatos();
        String idT = jTextField1.getText();
        eliminar.RegistroAlmacen(idT);
...
public void Limpiar(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VRegistroalmacen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VRegistroalmacen().setVisible(true);
            }
        });
    }
