...
public class VTipopago extends javax.swing.JFrame {

    /**
     * Creates new form VTipopago
     */
    public VTipopago() {
        initComponents();
    ...
    public void Listar(){
      ...
      ArrayList<TipoPago>lista1=new ArrayList<>();
       
      lista1=listar.TipoPago();
       ...
       for(TipoPago l:lista1){
           datos[0] =l.getIdTipoPago();
           datos[1]=l.getDescripción();
...
public void Modificar(){
        ...
        modificar.TipoPago(idT, idT2);
    }

public void Eliminar(){
        EliminarDatos eliminar = new EliminarDatos();
        String idT = jTextField1.getText();
        eliminar.TipoPago(idT);
...
public void Limpiar(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VTipopago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
