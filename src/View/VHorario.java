...
public class VHorario extends javax.swing.JFrame {

    /**
     * Creates new form VHorario
     */
    public VHorario() {
        initComponents();
    ...
    public void Listar(){
      ...
      lista1=listar.Horario();
      
       jTable2.setModel(mitabla);
       
       String[] titulos = {"Codigo","HorarioInicial","HorarioFinal"};
       ...
       for(Horario l:lista1){
           datos[0] =l.getIdHorario();
           datos[1]=l.getHorarioInicio();
           datos[2]=l.getHorarioFinal();
...
public void Insertar(){
        ...
        insertar.Horario(idT, idT2,text5);
    }
...
public void Modificar(){
        ...
        modificar.Horario(idT, idT2,text5);
    }

public void Eliminar(){
        EliminarDatos eliminar = new EliminarDatos();
        String idT = jTextField1.getText();
        eliminar.Horario(idT);
...
public void Limpiar(){
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        jTextField5.setText(jTable2.getValueAt(jTable2.getSelectedRow(), 2).toString());
